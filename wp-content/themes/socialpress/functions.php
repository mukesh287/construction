...
add_action( 'wp_enqueue_scripts', 'socialpress_enqueue_styles' );
function socialpress_enqueue_styles() {
	wp_enqueue_style( 'socialpress-parent-style', get_template_directory_uri() . '/style.css' ); 
} 



// Excerpt length
function socialpress_excerpt_length($length){
    if (is_admin()) {
        return $length;
    }
    return 25;
}
add_filter('excerpt_length', 'socialpress_excerpt_length', 999);


//Dequeue old font
function socialpress_dequeue_fonts() {
    wp_dequeue_style( 'membershiply-google-fonts' );
        wp_deregister_style( 'membershiply-google-fonts' );
}
add_action( 'wp_print_styles', 'socialpress_dequeue_fonts' );
...
// Customer settings
function socialpress_customize_register( $wp_customize ) {
...
$wp_customize->add_section( 'footer_settings', array(
		'title'      => __('Footer Settings','socialpress'),
		'priority'   => 1,
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'footer_headline_color', array(
		'label'       => __( 'Headline Color', 'socialpress' ),
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'footer_text_color', array(
		'label'       => __( 'Text Color', 'socialpress' ),
		'section'     => 'footer_settings',
		'priority'   => 1,
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'footer_link_color', array(
		'label'       => __( 'Link Color', 'socialpress' ),
		'section'     => 'footer_settings',
		'priority'   => 1,
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'footer_border_color', array(
		'label'       => __( 'Border Color', 'socialpress' ),
		'section'     => 'footer_settings',
		'priority'   => 1,
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'footer_background_color', array(
		'label'       => __( 'Background Color', 'socialpress' ),
		'section'     => 'footer_settings',
		'priority'   => 1,
...
add_action( 'customize_register', 'socialpress_customize_register', 999 );



function socialpress_enqueue_assets()
{
    // Include the file.
    ...
    wp_enqueue_style(
        'socialpress-fonts',
        wptt_get_webfont_url('https://fonts.googleapis.com/css2?family=Fira+Code:wght@400&family=Plus+Jakarta+Sans:wght@400;600&display=swap'),
        array(),
        '1.0'
    );
}
add_action('wp_enqueue_scripts', 'socialpress_enqueue_assets');



//Customizer output
if(! function_exists('socialpress_customizer_css_final_output' ) ):
	function socialpress_customizer_css_final_output(){
		?>
	...
	<?php }
	add_action( 'wp_head', 'socialpress_customizer_css_final_output', 999 );
endif;
